...
relSD_moving_7d <-  slider::slide_dfr(dailyprices, .before = 3, .after = 3, .complete = TRUE,
...
ggplot(relSD_moving_7d, aes(x = start, y = relSD)) +
  geom_line()
...
relSD_moving_7d_toplot <- relSD_moving_7d %>%
...
ggplot(relSD_moving_7d_toplot, aes(x = date)) +
